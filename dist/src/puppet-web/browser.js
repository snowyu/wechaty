...
class Browser extends events_1.EventEmitter {
    ...
    hostname() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const domain = yield this.execute('return location.hostname');
    ...
    open(url) {
        return __awaiter(this, void 0, void 0, function* () {
            config_1.log.verbose('PuppetWebBrowser', 'open(%s)', url);
            if (!url) {
                const hostname = this.cookie.hostname();
                if (!hostname) {
                ...
                try {
                    yield new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        try {
                            ...
                            // open successful!
                            config_1.log.verbose('PuppetWebBrowser', 'open(%s) end at ttl:%d', openUrl, ttl);
                            return resolve();
                        }
                        catch (e) {
                            return reject(e);
    ...
    quit() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this.driver.close()
                    .catch(e => {
                    config_1.log.error('PuppetWebBriowser', 'quit() this.driver.close() exception %s', e.message);
                });
    ...
    getBrowserPidList() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                config_1.log.error('PuppetWebBrowser', 'getBrowserPidList() exception: %s', e.message || e);
                throw e;
            }
        });
    }
    ...
    clickSwitchAccount() {
        return __awaiter(this, void 0, void 0, function* () {
            config_1.log.verbose('PuppetWebBrowser', 'clickSwitchAccount()');
            try {
                const button = yield this.driver.driver.findElement(browser_driver_1.By.xpath("//div[contains(@class,'association') and contains(@class,'show')]/a[@ng-click='qrcodeLogin()']"));
                button.click();
                config_1.log.silly('PuppetWebBrowser', 'clickSwitchAccount() clicked!');
                return true;
            }
            catch (e) {
                config_1.log.silly('PuppetWebBrowser', 'clickSwitchAccount() button not found');
                return false;
            }
        });
    }
