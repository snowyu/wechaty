...
class BrowserCookie {
    ...
    hostname() {
        ...
        if (!domain) {
            config_1.log.silly('PuppetWebBrowserCookie', 'hostname() no valid domain in cookies, return default hostname');
            return DEFAULT_HOSTNAME;
        }
    ...
    add(cookie) {
        return __awaiter(this, void 0, void 0, function* () {
            if (Array.isArray(cookie)) {
                ...
                config_1.log.verbose('PuppetWebBrowserCookie', 'add(Array.length = %d)', cookieList.length);
            ...
            config_1.log.silly('PuppetWebBrowserCookie', 'add(%s)', JSON.stringify(cookie));
            try {
                yield this.driver
                    .manage()
                    .addCookie(cookie);
                ...
                config_1.log.warn('PuppetWebBrowserCookie', 'add() exception: %s', e.message);
                throw e;
            }
        });
    }
