...
function onServerConnection(data) {
    config_1.log.verbose('PuppetWebEvent', 'onServerConnection: %s', typeof data);
}
/**
 * `disconnect` event
...
function onServerLogin(data, attempt = 0) {
    return __awaiter(this, arguments, void 0, function* () {
        ...
        if (!this.bridge) {
            config_1.log.verbose('PuppetWebEvent', 'onServerLogin() fired before bridge inited. delay for 1 second.');
            setTimeout(() => {
