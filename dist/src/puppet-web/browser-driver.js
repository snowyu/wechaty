...
exports.TargetLocator = selenium_webdriver_1.TargetLocator;
...
class BrowserDriver {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (this.head.toLowerCase()) {
                ...
                case 'firefox':
                    ...
                    break;
                case 'chrome':
                    this.driver = yield this.getChromeDriver(false); // headless = false
                    break;
                case 'chrome-headless':
                    this.driver = yield this.getChromeDriver(true); // headless = true
                    break;
    ...
    getChromeDriver(headless = false) {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                .set('chromeOptions', options);
            {
                ...
                let loggingLevel;
                switch (config_1.log.level()) {
                    case 'silly':
                        loggingLevel = selenium_webdriver_1.logging.Level.ALL;
                        break;
                    case 'verbose':
                        loggingLevel = selenium_webdriver_1.logging.Level.DEBUG;
                        break;
                    default:
                        loggingLevel = selenium_webdriver_1.logging.Level.OFF;
                }
                prefs.setLevel(selenium_webdriver_1.logging.Type.BROWSER, loggingLevel);
                prefs.setLevel(selenium_webdriver_1.logging.Type.CLIENT, loggingLevel);
                prefs.setLevel(selenium_webdriver_1.logging.Type.DRIVER, loggingLevel);
                prefs.setLevel(selenium_webdriver_1.logging.Type.PERFORMANCE, loggingLevel);
                prefs.setLevel(selenium_webdriver_1.logging.Type.SERVER, loggingLevel);
                ...
                try {
                    ...
                    if (valid) {
                        ...
                        driver.close()
                            ...
                            .catch(err => {
                            config_1.log.warn('PuppetWebBrowserDriver', 'getChromeDriver() driver.{close,quit}() exception: %s', err.message);
                            driverError = err;
                        });
                    } // END if
                }
    ...
    switchTo() { return this.driver.switchTo(); }
}
