...
class Bridge {
    ...
    blockedMessageBody() {
        return __awaiter(this, void 0, void 0, function* () {
            config_1.log.silly('PuppetWebBridge', 'blockedMessageBody()');
            const text = yield this.execute('return document.body.innerText');
            return new Promise((resolve, reject) => {
                xml2js_1.parseString(text, { explicitArray: false }, (err, obj) => {
                    if (err) {
                        return resolve(null);
                    }
                    if (!obj.error) {
    ...
    blockedMessageAlert() {
        return __awaiter(this, void 0, void 0, function* () {
            config_1.log.silly('PuppetWebBridge', 'blockedMessageAlert()');
