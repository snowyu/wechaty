...
ava_1.test('downloadStream() for media', (t) => __awaiter(this, void 0, void 0, function* () {
    const app = express();
    ...
    server.listen(65534);
    try {
        const s = yield util_lib_1.default.urlStream('http://127.0.0.1:65534/ding', [{ name: 'life', value: 42 }]);
